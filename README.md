...
### Picker
```js
import { Picker } from 'emoji-mart-vue-fixed2'
```
...
```js
import data from 'emoji-mart-vue-fixed2/data/messenger.json'
import { NimblePicker } from 'emoji-mart-vue-fixed2'
```
...
### Emoji
```js
import { Emoji } from 'emoji-mart-vue-fixed2'
```
...
```js
import { emojiIndex } from 'emoji-mart-vue-fixed2'
...
### With custom data
```js
import data from 'emoji-mart-vue-fixed2/data/messenger'
import { NimbleEmojiIndex } from 'emoji-mart-vue-fixed2'
...
```js
import { store } from 'emoji-mart-vue-fixed2'
